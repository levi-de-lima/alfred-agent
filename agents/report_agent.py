...
def _render_card(campos: list[dict]) -> str:
    ...
    for campo in campos:
        ...
        kpi_cells += (
            ...
            f'  <div class="kpi-value" style="font-size:clamp(14px,3vw,32px);font-weight:700;color:{value_color};">{valor}</div>\n'
        )
        if subtexto:
            kpi_cells += (
...
def _render_summary_card_legacy(result: AnalyticsResult) -> str:
    ...
    kpis = (
        ...
        f'    <div class="kpi-value" style="font-size:clamp(14px,3vw,32px); font-weight:700; color:var(--danger);">{_fmt(taxa)}%</div>\n'
        ...
        f'    <div class="kpi-value" style="font-size:clamp(14px,3vw,32px); font-weight:700; color:var(--danger);">{n_churn}</div>\n'
        f'    <div style="font-size:12px; font-weight:400; color:var(--text-secondary); margin-top:4px;">'
        ...
        f'    <div class="kpi-value" style="font-size:clamp(14px,3vw,32px); font-weight:700; color:var(--success);">{n_ativo}</div>\n'
        f'    <div style="font-size:12px; font-weight:400; color:var(--text-secondary); margin-top:4px;">'
